...
use pigeon_shared::{
    canonical_genesis_key, decode, encode, identity_id, make_relay_forward, roster_hash,
    routing_precedes, tls_spki_fingerprint, verify_card, verify_device_with_genesis,
    verify_relay_forward, verify_revocation, verify_roster_transition, verify_routing,
